    ...
    <section class="blog spad">
        <div class="container">
            <div class="card customCard">
                ...
                <div class="card-body">
                    <?php if($subcategories->product_subcategory->count() > 0): ?>
                        <div class="row">
                            <?php $__currentLoopData = $subcategories->product_subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-primary" role="alert">
                            <?php echo e($subcategories->name); ?> category product not found
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Dhacha\resources\views/frontend/subcategories-products.blade.php ENDPATH**/ ?>