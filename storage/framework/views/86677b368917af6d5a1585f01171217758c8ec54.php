    ...
    <section class="blog spad">
        <div class="container">
            <div class="card customCard">
                ...
                <div class="card-body">
                    <?php if($categories->product->count() > 0): ?>
                        <div class="row">
                            <?php $__currentLoopData = $categories->product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 col-xl-3">
                                    <div class="card ProductCard">
                                        <a href="<?php echo e(route('products.details', $product->slug)); ?>">
                                            <img src="<?php echo e(asset($product->image_one)); ?>" class="card-img-top productCard__img" alt="<?php echo e($product->product_title); ?>">
                                        </a>
                                        ...
                                        <div class="card-body productCard__body">
                                            ...
                                            <div class="productCard__btn">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <button class="cartSubmit btn btn-sm btn-success btn-wish" id="<?php echo e($product->slug); ?>" data-toggle="modal" data-target="#cartmodal" title="Add Cart" onclick="productview(this.id)"><i class="fa fa-shopping-cart"></i></button>

                                                    <form action="javascript:void(0)" method="POST">
                                                        <button class="wishlistSubmit btn btn-sm btn-success btn-wish" data-id="<?php echo e($product->id); ?>" title="Add Wishlist"><i class="fa fa-heart-o"></i></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php else: ?>
                        <div class="alert alert-primary" role="alert">
                            <?php echo e($categories->name); ?> category product not found
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Dhacha\resources\views/frontend/categories-products.blade.php ENDPATH**/ ?>