    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="<?php echo e(route('newslaters.index')); ?>" class="nav-link">Newslatter</a></li>
            </ul>
            <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\halumshop-master\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>