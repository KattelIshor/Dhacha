    ...
    <header class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid right-sidebar">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><span style="color: #17a2b8;">Halum</span>shop</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav second-navbar">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <h6 class="ml-2">৳ <?php echo e(Cart::subtotal()); ?></h6>
                        <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\halumshop-master\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>