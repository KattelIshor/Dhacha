...
<?php $__env->startSection('pagename', 'Slider'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">Slider Table
            <a href="<?php echo e(route('sliders.create')); ?>" class="btn btn-sm btn-primary mg-b-10 float-right">
                ...
                <tbody>
                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><img src="<?php echo e(asset($slide->image)); ?>" alt="slider image" width="80px" height="50px"></td>
                            <td>
                            ...
                            <td>
                                <?php if($slide->status == 1): ?>
                                    <?php echo e(Form::open(['route' => ['sliders.inactive.store', $slide->id], 'class' => 'd-inline-block'])); ?>

                                        <button type="submit" class="btn btn-sm btn-danger"><i class="fa fa-thumbs-down"></i></button>
                                    <?php echo e(Form::close()); ?>

                                <?php else: ?>
                                    <?php echo e(Form::open(['route' => ['sliders.active.store', $slide->id], 'class' => 'd-inline-block'])); ?>
                                ...
                                <a href="<?php echo e(route('sliders.edit', $slide->id)); ?>" class="btn btn-sm btn-warning">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>
                                <a href="javascript:void(0)" title="Delete" class="btn btn-sm btn-danger delete-category" data-toggle="modal" data-target="#modaldemo1" data-url="<?php echo e(url('admin/sliders/'.$slide->id)); ?>">
...
<?php echo $__env->make('backend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Dhacha\resources\views/backend/sliders/index.blade.php ENDPATH**/ ?>