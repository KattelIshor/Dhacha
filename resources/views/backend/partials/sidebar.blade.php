    <div class="sl-logo"><a href="{{ url('/') }}" target="_blank"><i class="fa fa-shopping-basket"></i> Halubshop</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('sliders.index') }}" class="nav-link">Sliders</a></li>
                ...
                <li class="nav-item"><a href="{{ route('newslaters.index') }}" class="nav-link">Newsletter</a></li>
            </ul>
            @endcan
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('seos.index') }}" class="nav-link">
                        SEO Setting
                    </a>
                </li>
            </ul>
